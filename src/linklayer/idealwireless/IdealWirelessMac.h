...
/**
 * IdealWirelessMac module.
 *
 * Requires external queue.
 * Accepted messages:
 *   - from Upper Layer: cPacket with Ieee802Ctrl controlInfo
 *   - from Lower Layer: IdealAirFrame
 * Sent messages:
 *   - to Upper Layer: cPacket (decapsulated from IdealAirFrame) with Ieee802Ctrl controlInfo
 *   - to Lower Layer: IdealAirFrame (encapsulated Upper Layer cPacket)
 */
